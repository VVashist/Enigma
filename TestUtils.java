...
class TestUtils {
    ...
    protected static final Alphabet LOWER = new Alphabet(
    ...
    protected static final String INCOMPLETE_ALPHA =
            "abcdefgABC";
    protected static final Alphabet INCOM_ALPHA =
            new Alphabet(INCOMPLETE_ALPHA);

    protected static final String TESTPARMU = "(adAc)  (fC)";
    protected static final String PERMA_ALPHA = "dbaAeCgcBf";
    protected static final String INVERT_ALPHA = "cbAaeCgdBf";
